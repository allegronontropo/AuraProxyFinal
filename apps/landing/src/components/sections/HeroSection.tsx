...
import {
  ...
  ContainerSticky,
  ContainerAnimated,
} from "@/components/animations/ScrollAndRoll";
...
export default function HeroSection() {
  return (
    <section
      id="hero"
      style={{ position: "relative", overflow: "hidden", background: "var(--aura-bg)" }}
    >
      {/* Dynamic Wave Canvas — full background, violet-tinted */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      {/* Radial overlay — blends wave into page background smoothly */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          zIndex: 1,
          background:
            "radial-gradient(ellipse 90% 55% at 50% 20%, rgba(5,5,7,0.4) 0%, rgba(5,5,7,0.75) 55%, #050507 100%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        style={{
          ...
          height: "400px",
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(124,92,252,0.18) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 1,
        }}
      />
        ...
        <ContainerScroll className="h-[280vh]">
          ...
          >
            ...
            <ContainerAnimated
              inputRange={[0.1, 0.55]}
              outputRange={[50, 0]}
              style={{ textAlign: "center", maxWidth: "860px", marginBottom: "3rem" }}
            >
              {/* Badge */}
              <div
                style={{
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    boxShadow: "0 0 0 0 rgba(124,92,252,0.4)",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = "0 8px 30px rgba(124,92,252,0.45)";
                    e.currentTarget.style.transform = "translateY(-1px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = "0 0 0 0 rgba(124,92,252,0.4)";
            ...
            {/* ── ARCHITECTURE VISUAL — transparent, no card wrapper ── */}
            <ContainerAnimated
              inputRange={[0.05, 0.5]}
              outputRange={[30, 0]}
